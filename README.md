...
* **Alya Version:** 0.0.17 (Compiled with `alyac build` in Release mode)
...
| :--- | :---: | :---: | :---: | :---: |
| **Geometric Mean Relative Speed** | **1.0x (Baseline)** | `0.39x` *(faster)* | `0.65x` | `0.07x` *(slower)* |
| **Alya Relative Performance** | **Reference Target** | **~2.6x of C** | **1.5x faster** | **14.7x faster** |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| `Algorithms` | **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.4 ms` | **`8.5 ms`** | `12.5 ms` | `120.4 ms` |
| `Algorithms` | **In-Place Quicksort** | 50,000 items in-place sort | `14.9 ms` | **`127.9 ms`** | `32.7 ms` | `1827.9 ms` |
| `Algorithms` | **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `6.8 ms` | `17.7 ms` |
| `Algorithms` | **Collatz Conjecture** | Under 100k (~2.16M steps) | `14.7 ms` | **`60.3 ms`** | `41.7 ms` | `737.6 ms` |
| `Algorithms` | **Binary Search** | 100k items, 50k lookups | `3.6 ms` | **`7.1 ms`** | `14.8 ms` | `114.5 ms` |
| `Collections` | **Binary Trees** | Heap tree allocation & traversal | `125.6 ms` | **`425.7 ms`** | `97.5 ms` | `2926.8 ms` |
| `Collections` | **Hash Map** | 20k insertions, updates & lookups | `4.4 ms` | **`11.3 ms`** | `14.9 ms` | `24.2 ms` |
| `Numeric` | **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.2 ms` | **`8.2 ms`** | `9.9 ms` | `128.6 ms` |
| `Numeric` | **Matrix Multiply** | 120×120 dense integer matrix mult | `1.2 ms` | **`7.4 ms`** | `12.7 ms` | `188.4 ms` |
| `Numeric` | **Monte Carlo Simulation** | 500,000 iterations (Pi approx) | `3.9 ms` | **`6.9 ms`** | `54.9 ms` | `190.7 ms` |
| `Strings` | **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`9.0 ms`** | `12.9 ms` | `427.3 ms` |
| `Memory` | **Linked List Allocation** | 50k node alloc & traversal | `3.1 ms` | **`3.0 ms`** | `7.6 ms` | `30.6 ms` |
| `Crypto` | **RC4 Stream Cipher** | 100k bytes KSA & PRGA stream | `1.1 ms` | **`2.0 ms`** | `7.7 ms` | `35.7 ms` |
| `Bitwise` | **Kernighan Popcount** | 100k integers bit-clearing | `2.4 ms` | **`4.1 ms`** | `9.3 ms` | `139.2 ms` |
...
| **In-Place Quicksort** | **14.3x faster** | `3.9x slower` | **8.6x** | 🟡 Near-Native |
| **Sieve of Eratosthenes** | **11.3x faster** | **4.4x faster** | **1.5x** | 🟢 Near-C |
| **Collatz Conjecture** | **12.2x faster** | `1.4x slower` | **4.1x** | 🟢 Native Fast |
| **Binary Search** | **16.0x faster** | **2.1x faster** | **2.0x** | 🟢 Near-C |
| **Binary Trees** | **6.9x faster** | `4.4x slower` | **3.4x** | 🟢 Native Fast |
| **Hash Map** | **2.1x faster** | **1.3x faster** | **2.6x** | 🟢 Native Fast |
| **Mandelbrot Fractal** | **15.7x faster** | **1.2x faster** | **2.6x** | 🟢 Native Fast |
| **Matrix Multiply** | **25.4x faster** | **1.7x faster** | **6.0x** | 🟡 Near-Native |
| **Monte Carlo Simulation** | **27.7x faster** | **8.0x faster** | **1.8x** | 🟢 Near-C |
| **FNV-1a String Hash** | **47.4x faster** | **1.4x faster** | **1.9x** | 🟢 Near-C |
| **Linked List Allocation** | **10.1x faster** | **2.5x faster** | **1.0x** | 🟢 Near-C |
| **RC4 Stream Cipher** | **18.3x faster** | **3.9x faster** | **1.7x** | 🟢 Near-C |
| **Kernighan Popcount** | **34.4x faster** | **2.3x faster** | **1.7x** | 🟢 Near-C |
...
* **Result:** **8.6x of C (-O2)**, **3.9x slower than Bun**, and **14.3x faster than Python**.
...
* **Result:** **1.5x of C (-O2)**, **4.4x faster than Bun**, and **11.3x faster than Python**.
...
* **Result:** **2.0x of C (-O2)**, **2.1x faster than Bun**, and **16.0x faster than Python**.
...
* **Result:** **3.4x of C (-O2)**, **4.4x slower than Bun**, and **6.9x faster than Python**.
...
* **Result:** **2.6x of C (-O2)**, **1.3x faster than Bun**, and **2.1x faster than Python**.
...
* **Result:** **2.6x of C (-O2)**, **1.2x faster than Bun**, and **15.7x faster than Python**.
...
* **Result:** **6.0x of C (-O2)**, **1.7x faster than Bun**, and **25.4x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **8.0x faster than Bun**, and **27.7x faster than Python**.
...
* **Result:** **1.9x of C (-O2)**, **1.4x faster than Bun**, and **47.4x faster than Python**.
...
* **Result:** **1.7x of C (-O2)**, **3.9x faster than Bun**, and **18.3x faster than Python**.
...
* **Result:** **1.7x of C (-O2)**, **2.3x faster than Bun**, and **34.4x faster than Python**.

...
* **Alya Version:** 0.0.18 (Compiled with `alyac build` in Release mode)
...
| **Alya Relative Performance** | **Reference Target** | **~2.5x of C** | **1.5x faster** | **14.7x faster** |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| `Algorithms` | **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.6 ms` | **`9.1 ms`** | `13.3 ms` | `122.4 ms` |
| `Algorithms` | **In-Place Quicksort** | 50,000 items in-place sort | `15.0 ms` | **`127.9 ms`** | `28.2 ms` | `1845.3 ms` |
| `Algorithms` | **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `7.0 ms` | `17.6 ms` |
| `Algorithms` | **Collatz Conjecture** | Under 100k (~2.16M steps) | `14.6 ms` | **`59.0 ms`** | `41.6 ms` | `745.5 ms` |
| `Algorithms` | **Binary Search** | 100k items, 50k lookups | `3.9 ms` | **`7.1 ms`** | `16.2 ms` | `115.8 ms` |
| `Collections` | **Binary Trees** | Heap tree allocation & traversal | `126.0 ms` | **`435.7 ms`** | `98.6 ms` | `2897.3 ms` |
| `Collections` | **Hash Map** | 20k insertions, updates & lookups | `4.4 ms` | **`11.8 ms`** | `14.7 ms` | `24.2 ms` |
| `Numeric` | **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.1 ms` | **`8.1 ms`** | `9.2 ms` | `122.0 ms` |
| `Numeric` | **Matrix Multiply** | 120×120 dense integer matrix mult | `1.2 ms` | **`7.3 ms`** | `12.0 ms` | `189.8 ms` |
| `Numeric` | **Monte Carlo Simulation** | 500,000 iterations (Pi approx) | `3.8 ms` | **`6.7 ms`** | `55.1 ms` | `190.4 ms` |
| `Strings` | **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`9.0 ms`** | `13.0 ms` | `429.1 ms` |
| `Memory` | **Linked List Allocation** | 50k node alloc & traversal | `3.0 ms` | **`2.9 ms`** | `7.9 ms` | `30.0 ms` |
| `Crypto` | **RC4 Stream Cipher** | 100k bytes KSA & PRGA stream | `1.1 ms` | **`1.9 ms`** | `7.1 ms` | `35.0 ms` |
| `Bitwise` | **Kernighan Popcount** | 100k integers bit-clearing | `2.3 ms` | **`3.8 ms`** | `8.9 ms` | `139.0 ms` |
...
| :--- | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | **13.5x faster** | **1.5x faster** | **3.5x** | 🟢 Native Fast |
| **In-Place Quicksort** | **14.4x faster** | `4.5x slower` | **8.5x** | 🟡 Near-Native |
| **Sieve of Eratosthenes** | **11.2x faster** | **4.4x faster** | **1.6x** | 🟢 Near-C |
| **Collatz Conjecture** | **12.6x faster** | `1.4x slower` | **4.0x** | 🟢 Native Fast |
| **Binary Search** | **16.2x faster** | **2.3x faster** | **1.8x** | 🟢 Near-C |
| **Binary Trees** | **6.6x faster** | `4.4x slower` | **3.5x** | 🟢 Native Fast |
| **Hash Map** | **2.0x faster** | **1.2x faster** | **2.7x** | 🟢 Native Fast |
| **Mandelbrot Fractal** | **15.0x faster** | **1.1x faster** | **2.6x** | 🟢 Native Fast |
| **Matrix Multiply** | **25.9x faster** | **1.6x faster** | **5.9x** | 🟡 Near-Native |
| **Monte Carlo Simulation** | **28.4x faster** | **8.2x faster** | **1.8x** | 🟢 Near-C |
| **FNV-1a String Hash** | **47.9x faster** | **1.5x faster** | **1.9x** | 🟢 Near-C |
| **Linked List Allocation** | **10.3x faster** | **2.7x faster** | **1.0x** | 🟢 Near-C |
| **RC4 Stream Cipher** | **18.2x faster** | **3.7x faster** | **1.8x** | 🟢 Near-C |
| **Kernighan Popcount** | **36.8x faster** | **2.4x faster** | **1.6x** | 🟢 Near-C |
...
* **Result:** **3.5x of C (-O2)**, **1.5x faster than Bun**, and **13.5x faster than Python**.
...
* **Result:** **8.5x of C (-O2)**, **4.5x slower than Bun**, and **14.4x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.4x faster than Bun**, and **11.2x faster than Python**.
...
* **Result:** **4.0x of C (-O2)**, **1.4x slower than Bun**, and **12.6x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **2.3x faster than Bun**, and **16.2x faster than Python**.
...
* **Result:** **3.5x of C (-O2)**, **4.4x slower than Bun**, and **6.6x faster than Python**.
...
* **Result:** **1.9x of C (-O2)**, **1.5x faster than Bun**, and **47.9x faster than Python**.
...
* **Result:** **1.0x of C (-O2)**, **2.7x faster than Bun**, and **10.3x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **3.7x faster than Bun**, and **18.2x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **2.4x faster than Bun**, and **36.8x faster than Python**.

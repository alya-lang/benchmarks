...
| **Alya Relative Performance** | **Reference Target** | **~2.6x of C** | **1.5x faster** | **14.4x faster** |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| `Algorithms` | **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.4 ms` | **`8.7 ms`** | `12.8 ms` | `121.8 ms` |
| `Algorithms` | **In-Place Quicksort** | 50,000 items in-place sort | `14.6 ms` | **`130.9 ms`** | `32.8 ms` | `1917.7 ms` |
| `Algorithms` | **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.8 ms`** | `6.4 ms` | `17.3 ms` |
| `Algorithms` | **Collatz Conjecture** | Under 100k (~2.16M steps) | `14.6 ms` | **`58.8 ms`** | `41.8 ms` | `745.0 ms` |
| `Algorithms` | **Binary Search** | 100k items, 50k lookups | `3.6 ms` | **`7.1 ms`** | `14.5 ms` | `115.8 ms` |
| `Collections` | **Binary Trees** | Heap tree allocation & traversal | `125.4 ms` | **`403.1 ms`** | `97.5 ms` | `2796.6 ms` |
| `Collections` | **Hash Map** | 20k insertions, updates & lookups | `4.4 ms` | **`10.5 ms`** | `14.9 ms` | `24.2 ms` |
| `Numeric` | **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.1 ms` | **`12.8 ms`** | `9.7 ms` | `122.1 ms` |
| `Numeric` | **Matrix Multiply** | 120×120 dense integer matrix mult | `1.2 ms` | **`6.6 ms`** | `11.9 ms` | `187.5 ms` |
| `Numeric` | **Monte Carlo Simulation** | 500,000 iterations (Pi approx) | `3.8 ms` | **`6.8 ms`** | `54.9 ms` | `190.0 ms` |
| `Strings` | **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.8 ms`** | `13.0 ms` | `430.4 ms` |
| `Memory` | **Linked List Allocation** | 50k node alloc & traversal | `2.9 ms` | **`3.0 ms`** | `7.2 ms` | `30.1 ms` |
| `Crypto` | **RC4 Stream Cipher** | 100k bytes KSA & PRGA stream | `1.1 ms` | **`2.0 ms`** | `7.7 ms` | `34.4 ms` |
| `Bitwise` | **Kernighan Popcount** | 100k integers bit-clearing | `2.3 ms` | **`3.8 ms`** | `8.7 ms` | `137.7 ms` |
...
| :--- | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | **13.9x faster** | **1.5x faster** | **3.7x** | 🟢 Native Fast |
| **In-Place Quicksort** | **14.6x faster** | `4.0x slower` | **9.0x** | 🟡 Near-Native |
| **Sieve of Eratosthenes** | **9.6x faster** | **3.6x faster** | **1.8x** | 🟢 Near-C |
| **Collatz Conjecture** | **12.7x faster** | `1.4x slower` | **4.0x** | 🟢 Native Fast |
| **Binary Search** | **16.4x faster** | **2.1x faster** | **2.0x** | 🟢 Near-C |
| **Binary Trees** | **6.9x faster** | `4.1x slower` | **3.2x** | 🟢 Native Fast |
| **Hash Map** | **2.3x faster** | **1.4x faster** | **2.4x** | 🟢 Native Fast |
| **Mandelbrot Fractal** | **9.5x faster** | `1.3x slower` | **4.1x** | 🟢 Native Fast |
| **Matrix Multiply** | **28.5x faster** | **1.8x faster** | **5.3x** | 🟡 Near-Native |
| **Monte Carlo Simulation** | **28.1x faster** | **8.1x faster** | **1.8x** | 🟢 Near-C |
| **FNV-1a String Hash** | **48.7x faster** | **1.5x faster** | **1.9x** | 🟢 Near-C |
| **Linked List Allocation** | **10.2x faster** | **2.4x faster** | **1.0x** | 🟢 Near-C |
| **RC4 Stream Cipher** | **17.5x faster** | **3.9x faster** | **1.8x** | 🟢 Near-C |
| **Kernighan Popcount** | **36.5x faster** | **2.3x faster** | **1.6x** | 🟢 Near-C |
...
* **Result:** **3.7x of C (-O2)**, **1.5x faster than Bun**, and **13.9x faster than Python**.
...
* **Result:** **9.0x of C (-O2)**, **4.0x slower than Bun**, and **14.6x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **3.6x faster than Bun**, and **9.6x faster than Python**.
...
* **Result:** **2.0x of C (-O2)**, **2.1x faster than Bun**, and **16.4x faster than Python**.
...
* **Result:** **3.2x of C (-O2)**, **4.1x slower than Bun**, and **6.9x faster than Python**.
...
* **Result:** **2.4x of C (-O2)**, **1.4x faster than Bun**, and **2.3x faster than Python**.
...
* **Result:** **5.3x of C (-O2)**, **1.8x faster than Bun**, and **28.5x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **8.1x faster than Bun**, and **28.1x faster than Python**.
...
* **Result:** **1.9x of C (-O2)**, **1.5x faster than Bun**, and **48.7x faster than Python**.
...
* **Result:** **1.0x of C (-O2)**, **2.4x faster than Bun**, and **10.2x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **3.9x faster than Bun**, and **17.5x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **2.3x faster than Bun**, and **36.5x faster than Python**.

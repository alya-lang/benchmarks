...
* **Alya Version:** 0.0.6 (Compiled with `alyac build` in Release mode)
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `Algorithms` | **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.3 ms` | **`8.6 ms`** | `12.9 ms` | `121.6 ms` | **3.7x** | **14.1x faster** | **1.5x faster** |
| `Algorithms` | **In-Place Quicksort** | 50,000 items in-place sort | `14.7 ms` | **`128.1 ms`** | `28.1 ms` | `1807.2 ms` | **8.7x** | **14.1x faster** | `4.6x slower` |
| `Algorithms` | **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `6.8 ms` | `17.5 ms` | **1.6x** | **11.1x faster** | **4.3x faster** |
| `Collections` | **Binary Trees** | Heap tree allocation & traversal | `107.4 ms` | **`432.2 ms`** | `96.8 ms` | `2784.8 ms` | **4.0x** | **6.4x faster** | `4.5x slower` |
| `Collections` | **Hash Map** | 20k insertions, updates & lookups | `4.3 ms` | **`10.5 ms`** | `14.7 ms` | `23.8 ms` | **2.4x** | **2.3x faster** | **1.4x faster** |
| `Numeric` | **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.1 ms` | **`8.1 ms`** | `9.1 ms` | `122.0 ms` | **2.6x** | **15.0x faster** | **1.1x faster** |
| `Numeric` | **Matrix Multiply** | 120×120 dense integer matrix mult | `1.2 ms` | **`7.3 ms`** | `11.8 ms` | `189.7 ms` | **5.9x** | **26.0x faster** | **1.6x faster** |
| `Strings` | **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.8 ms`** | `12.6 ms` | `426.1 ms` | **1.9x** | **48.3x faster** | **1.4x faster** |
...
* **Result:** **3.7x of C (-O2)**, **1.5x faster than Bun**, and **14.1x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.3x faster than Bun**, and **11.1x faster than Python**.
...
* **Result:** **8.7x of C (-O2)**, **4.6x slower than Bun**, and **14.1x faster than Python**.
...
* **Result:** **4.0x of C (-O2)**, **4.5x slower than Bun**, and **6.4x faster than Python**.
...
* **Result:** **5.9x of C (-O2)**, **1.6x faster than Bun**, and **26.0x faster than Python**.

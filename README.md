...
| **Alya Relative Performance** | **Reference Target** | **~2.7x of C** | **1.4x faster** | **14.2x faster** |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| `Algorithms` | **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.4 ms` | **`8.7 ms`** | `13.0 ms` | `120.3 ms` |
| `Algorithms` | **In-Place Quicksort** | 50,000 items in-place sort | `14.6 ms` | **`130.6 ms`** | `32.7 ms` | `1812.3 ms` |
| `Algorithms` | **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.8 ms`** | `6.6 ms` | `16.8 ms` |
| `Algorithms` | **Collatz Conjecture** | Under 100k (~2.16M steps) | `14.6 ms` | **`58.5 ms`** | `41.4 ms` | `737.5 ms` |
| `Algorithms` | **Binary Search** | 100k items, 50k lookups | `3.6 ms` | **`7.0 ms`** | `14.2 ms` | `113.2 ms` |
| `Collections` | **Binary Trees** | Heap tree allocation & traversal | `106.9 ms` | **`400.2 ms`** | `96.3 ms` | `2653.1 ms` |
| `Collections` | **Hash Map** | 20k insertions, updates & lookups | `4.4 ms` | **`10.4 ms`** | `14.4 ms` | `23.3 ms` |
| `Numeric` | **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.1 ms` | **`12.8 ms`** | `8.9 ms` | `121.0 ms` |
| `Numeric` | **Matrix Multiply** | 120×120 dense integer matrix mult | `1.2 ms` | **`6.6 ms`** | `12.0 ms` | `188.4 ms` |
| `Numeric` | **Monte Carlo Simulation** | 500,000 iterations (Pi approx) | `3.8 ms` | **`6.7 ms`** | `54.8 ms` | `191.1 ms` |
| `Strings` | **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.9 ms`** | `12.2 ms` | `449.2 ms` |
| `Memory` | **Linked List Allocation** | 50k node alloc & traversal | `3.0 ms` | **`2.9 ms`** | `6.9 ms` | `28.9 ms` |
| `Crypto` | **RC4 Stream Cipher** | 100k bytes KSA & PRGA stream | `1.1 ms` | **`2.0 ms`** | `6.8 ms` | `34.4 ms` |
| `Bitwise` | **Kernighan Popcount** | 100k integers bit-clearing | `2.3 ms` | **`3.8 ms`** | `8.6 ms` | `137.5 ms` |
...
| :--- | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | **13.8x faster** | **1.5x faster** | **3.7x** | 🟢 Native Fast |
| **In-Place Quicksort** | **13.9x faster** | `4.0x slower` | **9.0x** | 🟡 Near-Native |
| **Sieve of Eratosthenes** | **9.4x faster** | **3.7x faster** | **1.8x** | 🟢 Near-C |
| **Collatz Conjecture** | **12.6x faster** | `1.4x slower` | **4.0x** | 🟢 Native Fast |
| **Binary Search** | **16.2x faster** | **2.0x faster** | **2.0x** | 🟢 Near-C |
| **Binary Trees** | **6.6x faster** | `4.2x slower` | **3.7x** | 🟢 Native Fast |
| **Hash Map** | **2.2x faster** | **1.4x faster** | **2.4x** | 🟢 Native Fast |
| **Mandelbrot Fractal** | **9.5x faster** | `1.4x slower` | **4.1x** | 🟢 Native Fast |
| **Matrix Multiply** | **28.7x faster** | **1.8x faster** | **5.3x** | 🟡 Near-Native |
| **Monte Carlo Simulation** | **28.4x faster** | **8.1x faster** | **1.8x** | 🟢 Near-C |
| **FNV-1a String Hash** | **50.7x faster** | **1.4x faster** | **1.9x** | 🟢 Near-C |
| **Linked List Allocation** | **10.0x faster** | **2.4x faster** | **1.0x** | 🟢 Near-C |
| **RC4 Stream Cipher** | **17.5x faster** | **3.5x faster** | **1.8x** | 🟢 Near-C |
...
* **Result:** **3.7x of C (-O2)**, **1.5x faster than Bun**, and **13.8x faster than Python**.
...
* **Result:** **9.0x of C (-O2)**, **4.0x slower than Bun**, and **13.9x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **3.7x faster than Bun**, and **9.4x faster than Python**.
...
* **Result:** **2.0x of C (-O2)**, **2.0x faster than Bun**, and **16.2x faster than Python**.
...
* **Result:** **3.7x of C (-O2)**, **4.2x slower than Bun**, and **6.6x faster than Python**.
...
* **Result:** **5.3x of C (-O2)**, **1.8x faster than Bun**, and **28.7x faster than Python**.
...
* **Result:** **1.9x of C (-O2)**, **1.4x faster than Bun**, and **50.7x faster than Python**.
...
* **Result:** **1.0x of C (-O2)**, **2.4x faster than Bun**, and **10.0x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **3.5x faster than Bun**, and **17.5x faster than Python**.

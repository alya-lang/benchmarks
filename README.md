...
| :--- | :---: | :---: | :---: | :---: |
| **Geometric Mean Relative Speed** | **1.0x (Baseline)** | `0.40x` *(faster)* | `0.57x` | `0.06x` *(slower)* |
| **Alya Relative Performance** | **Reference Target** | **~2.5x of C** | **1.7x faster** | **15.6x faster** |
...
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| `Algorithms` | **Recursive Fibonacci** | `fib(30)` (~2.69M calls) | `2.3 ms` | **`8.9 ms`** | `12.8 ms` | `121.1 ms` |
| `Algorithms` | **In-Place Quicksort** | 50,000 items in-place sort | `14.8 ms` | **`130.2 ms`** | `32.8 ms` | `1813.5 ms` |
| `Algorithms` | **Sieve of Eratosthenes** | Primes under 50,000 | `1.0 ms` | **`1.6 ms`** | `6.6 ms` | `16.9 ms` |
| `Algorithms` | **Collatz Conjecture** | Under 100k (~2.16M steps) | `14.5 ms` | **`58.4 ms`** | `41.1 ms` | `741.3 ms` |
| `Algorithms` | **Binary Search** | 100k items, 50k lookups | `3.6 ms` | **`7.4 ms`** | `14.3 ms` | `114.4 ms` |
| `Collections` | **Hash Map** | 20k insertions, updates & lookups | `4.4 ms` | **`10.6 ms`** | `15.1 ms` | `23.8 ms` |
| `Numeric` | **Mandelbrot Fractal** | 200×100 grid, 200 iters | `3.1 ms` | **`8.0 ms`** | `9.7 ms` | `121.3 ms` |
| `Numeric` | **Matrix Multiply** | 120×120 dense integer matrix mult | `1.2 ms` | **`6.4 ms`** | `12.1 ms` | `189.8 ms` |
| `Numeric` | **Monte Carlo Simulation** | 500,000 iterations (Pi approx) | `3.8 ms` | **`6.7 ms`** | `54.8 ms` | `189.9 ms` |
| `Strings` | **FNV-1a String Hash** | 50,000 hash calculations | `4.7 ms` | **`8.9 ms`** | `12.4 ms` | `427.4 ms` |
| `Memory` | **Linked List Allocation** | 50k node alloc & traversal | `2.9 ms` | **`2.9 ms`** | `7.1 ms` | `28.9 ms` |
| `Crypto` | **RC4 Stream Cipher** | 100k bytes KSA & PRGA stream | `1.1 ms` | **`2.0 ms`** | `6.7 ms` | `33.7 ms` |
| `Bitwise` | **Kernighan Popcount** | 100k integers bit-clearing | `2.3 ms` | **`3.8 ms`** | `8.2 ms` | `137.4 ms` |
...
| :--- | :---: | :---: | :---: | :---: |
| **Recursive Fibonacci** | **13.6x faster** | **1.4x faster** | **3.8x** | 🟢 Native Fast |
| **In-Place Quicksort** | **13.9x faster** | `4.0x slower` | **8.8x** | 🟡 Near-Native |
| **Sieve of Eratosthenes** | **10.2x faster** | **4.0x faster** | **1.6x** | 🟢 Near-C |
...
| **Mandelbrot Fractal** | **15.2x faster** | **1.2x faster** | **2.6x** | 🟢 Native Fast |
| **Matrix Multiply** | **29.7x faster** | **1.9x faster** | **5.2x** | 🟡 Near-Native |
| **Monte Carlo Simulation** | **28.3x faster** | **8.2x faster** | **1.8x** | 🟢 Near-C |
| **FNV-1a String Hash** | **48.0x faster** | **1.4x faster** | **1.9x** | 🟢 Near-C |
| **Linked List Allocation** | **10.1x faster** | **2.5x faster** | **1.0x** | 🟢 Near-C |
| **RC4 Stream Cipher** | **17.1x faster** | **3.4x faster** | **1.8x** | 🟢 Near-C |
| **Kernighan Popcount** | **36.3x faster** | **2.2x faster** | **1.6x** | 🟢 Near-C |
...
* **Result:** **3.8x of C (-O2)**, **1.4x faster than Bun**, and **13.6x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **4.0x faster than Bun**, and **10.2x faster than Python**.
...
* **Result:** **5.2x of C (-O2)**, **1.9x faster than Bun**, and **29.7x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **8.2x faster than Bun**, and **28.3x faster than Python**.
...
* **Result:** **1.9x of C (-O2)**, **1.4x faster than Bun**, and **48.0x faster than Python**.
...
* **Result:** **1.8x of C (-O2)**, **3.4x faster than Bun**, and **17.1x faster than Python**.
...
* **Result:** **1.6x of C (-O2)**, **2.2x faster than Bun**, and **36.3x faster than Python**.
